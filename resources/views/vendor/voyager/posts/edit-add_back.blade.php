                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                $exclude = ['title', 'body', 'teaser', 'slug', 'status', 'author_id', 'image', 'youtube', 'meta_desc', 'meta_title', 'created_at'];
                            @endphp
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="created_at">Публікацію створено</label>
                                <input type="text" class="form-control" name="created_at" placeholder="Мета Заголовок" value="{{ $dataTypeContent->created_at ?? '' }}" disabled>
                            </div>
                            {{-- <div class="form-group">
