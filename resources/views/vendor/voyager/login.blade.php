...
<head>
    ...
    <style>
        body {
            background-image:url('{{ asset('dashlogin.jpg') }}');
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            ...
                            <p>Ласкаво просимо до панелі адміністрування</p>
                        </div>
            ...
            <div class="login-container">
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <div class="form-group" id="rememberMeGroup">
                        <div class="controls">
                        <input type="checkbox" name="remember" id="remember" value="1"><label for="remember" class="remember-me-text">Запамʼятати мене</label>
                        </div>
                    </div>
